...
namespace Net.Business.Services.Controllers
{
    ...
    public class OpcionController : ControllerBase
    {
        ...
        public async Task<IActionResult> GetAll([FromQuery] DtoOpcionFindRequest value)
        {
        ...
        {
            var objectGetById = await _repository.Opcion.GetById(new DtoOpcionFindRequest { IdMenu = id }.RetornarOpcion());
        ...
        public async Task<IActionResult> Create([FromBody] DtoOpcionInsertarRequest value)
        {
            if (value == null)
            {
        ...
        [ProducesResponseType(StatusCodes.Status404NotFound)]
        public async Task<IActionResult> Update([FromBody] DtoOpcionActualizarRequest value)
        {
            if (value == null)
            {
        ...
        public async Task<IActionResult> Delete([FromBody] DtoOpcionEliminarRequest value)
        {
            if (value == null)
            {
                return BadRequest(ModelState);
