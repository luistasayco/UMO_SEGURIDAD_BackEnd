...
namespace Net.Business.Services.Controllers
{
    ...
    public class ParametroConexionController : ControllerBase
    {
        ...
        {
            var objectGetById = await _repository.ParametroConexion.GetById(new DtoParametroConexionFindRequest { IdParametroConexion = id }.RetornarParametroConexion());
        ...
        public async Task<IActionResult> Create([FromBody] DtoParametroConexionInsertarRequest value)
        {
            if (value == null)
            {
        ...
        [ProducesResponseType(StatusCodes.Status404NotFound)]
        public async Task<IActionResult> Update([FromBody] DtoParametroConexionActualizarRequest value)
        {
            if (value == null)
            {
        ...
        public async Task<IActionResult> Delete([FromBody] DtoParametroConexionEliminarRequest value)
        {
            if (value == null)
            {
                return BadRequest(ModelState);
