...
namespace Net.Business.Services.Controllers
{
    ...
    public class ParametroSistemaController : ControllerBase
    {
        ...
        {
            var objectGetById = await _repository.ParametroSistema.GetById(new DtoParametroSistemaFindRequest { IdParametrosSistema = id }.RetornaParametroSistema());
        ...
        public async Task<IActionResult> Create([FromBody] DtoParametroSistemaInsertarRequest value)
        {
            if (value == null)
            {
        ...
        [ProducesResponseType(StatusCodes.Status404NotFound)]
        public async Task<IActionResult> Update([FromBody] DtoParametroSistemaActualizarRequest value)
        {
            if (value == null)
            {
        ...
        public async Task<IActionResult> Delete([FromBody] DtoParametroSistemaEliminarRequest value)
        {
            if (value == null)
            {
                return BadRequest(ModelState);
