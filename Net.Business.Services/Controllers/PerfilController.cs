...
namespace Net.Business.Services.Controllers
{
    ...
    public class PerfilController : ControllerBase
    {
        ...
        public async Task<IActionResult> GetAll([FromQuery] DtoPerfilFindRequest value)
        {
        ...
        {
            var objectGetById = await _repository.Perfil.GetById(new DtoPerfilFindRequest { IdPerfil = id }.RetornarPeril());
        ...
        public async Task<IActionResult> Create([FromBody] DtoPerfilInsertarRequest value)
        {
            if (value == null)
            {
        ...
        [ProducesResponseType(StatusCodes.Status404NotFound)]
        public async Task<IActionResult> Update([FromBody] DtoPerfilActualizarRequest value)
        {
            if (value == null)
            {
        ...
        public async Task<IActionResult> Delete([FromBody] DtoPerfilEliminarRequest value)
        {
            if (value == null)
            {
                return BadRequest(ModelState);
